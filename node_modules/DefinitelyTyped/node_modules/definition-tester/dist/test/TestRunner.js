...
var TestRunner = (function () {
    ...
    TestRunner.prototype.runTests = function (files) {
        ...
        return Promise.attempt(function () {
        ...
        }).spread(function (syntaxFiles, testFiles, headerFiles) {
            _this.print.init(files.length, syntaxFiles.length, testFiles.length);
            ...
            if (_this.options.tscparams) {
                _this.addSuite(tscparams);
            }
